...
```toml
[dependencies]
rlibphonenumber = { version = "1.1.0", default-features = false, features = ["lite", "global_static"] }
```
...
```toml
[dependencies]
rlibphonenumber = { version = "1.1.0", default-features = false, features = ["regex"] }
```
